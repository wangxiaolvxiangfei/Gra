        ...
        public JsonResult GetCity(string content)
       {
        ...
        public ActionResult FillBaseInfo(FillBaseInfoViewModel students)
        {
            if (ModelState.IsValid)
            {
                ...
                students.baseInfo.StuEditTime = DateTime.Now;
                    //如果基本信息表中已经有基本，则为更新
        ...
        public ActionResult FillApplInfo(ApplInfoViewModel students)
        {
            if (ModelState.IsValid)
            {
                ...
                if (db.ApplInfoTb.Find(students.applInfo.StudentNumber) != null)
                {
                    ...
                    students.applInfo.StudentEditTime = DateTime.Now;
        ...
        public ActionResult FillSignInfo()
        {
            ...
            if (Session["number"] != null)
            {
                ...
                student.signInfo.ComBelongDep = student.signInfo.ComBelongDep + student.signInfo.ComBelongDepCode;//隶属部门
        ...
        public ActionResult FillSignInfo(SignInfoViewModel students)
        {
            if (ModelState.IsValid)
            {
                ...
                students.signInfo.StuEditTime = DateTime.Now;
                //如果基本信息表中已经有基本，则为更新
        ...
        public ActionResult FillESchoolInfo()
        {
            ...
            foreach (var item in belong)
            {
                var listitem = new SelectListItem { Text = item.ComBelongDep, Value = item.ComBelongDepCode  };
        ...
        public ActionResult FillESchoolInfo(ESchoolInfoViewModel students)
        {
            if (ModelState.IsValid)
            {
                ...
                //学生编辑时间
                students.eSchoolInfo.StudentEditTime = DateTime.Now;
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult FillESchoolContractInfo()
        {
            #region 下拉框初始化
            //单位所属集团或系统
            List<SelectListItem> Group = new List<SelectListItem> {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult FillESchoolContractInfo(ESchoolInfoViewModel students)
        {
            if (ModelState.IsValid)
            {
                //单位性质
                ...
                //所属单位
                string belongDep = students.eSchoolInfo.ComBelongDep;
                students.eSchoolInfo.ComBelongDep = belongDep.Substring(3);
                ...
                return RedirectToAction("FillESchoolContractInfo");
            }
            return View(students);
        }
